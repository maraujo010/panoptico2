...
<div class="row register-content">
	<div class="col-md-3 col-md-offset-2 register-form">		
		<form method="POST" action="/register">
			...
			<fieldset>		 	
				...
				<div class="form-group">
					...
					<input type="email" name="email_confirmation" class="form-control" value="{{ old('email') }}">						
				</div>
				<div class="form-group">
	...
	<div class="col-md-4 col-md-offset-1 register-text">
		<p>
